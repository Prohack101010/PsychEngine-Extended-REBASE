...
class Difficulty
{
	...
	public static var mechanicsList(default, never):Array<String> = ['Off', 'Standard', 'Hell'];
	...
	private static var defaultMech(default, never):String = 'Standrad';
	...
	inline public static function getMehcanicsDifficultyString():String
	{
		return mechanicsList[PlayState.mechsDifficulty];
	}

	inline public static function getDefaultMech():String
	{
		return defaultMech;
	}
}