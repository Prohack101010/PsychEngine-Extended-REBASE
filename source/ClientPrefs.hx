...
class ClientPrefs {
	...
	public var touchmenus:Bool = false;
	public var Modpack:Bool = false;
	public var breakgetvarinarray:Bool = false;
	public var coloredvpad:Bool = true;
	public var VPadSpaceExtend:Bool = true;
	public var VPadShiftExtend:Bool = true;
	...
	public var hitboxExtend:Int = 2;
	public var hitboxLocation:String = 'Bottom';
	public var hitboxalpha:Float = 0.7; //someone request this lol
