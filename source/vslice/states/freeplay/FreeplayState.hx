package vslice.states.freeplay;
...
import vslice.funkin.AtlasText;
...
import Highscore;
import vslice.funkin.MathUtil;
import vslice.funkin.IntervalShake;
import WeekData;
import backend.animation.FlxAtlasSprite;
import vslice.substates.StickerSubState;
...
using vslice.funkin.FunkinTools;
using vslice.funkin.ArrayTools;
using StringTools;
