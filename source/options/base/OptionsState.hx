	...
	function openSelectedSubstate(label:String) {
		...
		switch(label) {
			case 'Note Colors':
				...
				removeVirtualPad();
				#end
				openSubState(new options.base.NotesSubState());
			...
			case 'Controls':
			    ...
			    if (ClientPrefs.VirtualPadAlpha == 0) { openSubState(new options.base.ControlsSubState()); }
				#else
				openSubState(new options.base.ControlsSubState());
				#end
			case 'Graphics':
				#if mobile
				removeVirtualPad();
				#end
				openSubState(new options.base.GraphicsSettingsSubState());
			case 'Visuals':
				#if mobile
				removeVirtualPad();
				#end
				openSubState(new options.base.VisualsSubState());
			case 'Gameplay':
				#if mobile
				removeVirtualPad();
				#end
				openSubState(new options.base.GameplaySettingsSubState());
			#if mobile
			case 'Mobile Options':
				removeVirtualPad();
			...
			case 'Adjust Delay and Combo':
				LoadingState.loadAndSwitchState(new options.base.NoteOffsetState());
		}
	}
