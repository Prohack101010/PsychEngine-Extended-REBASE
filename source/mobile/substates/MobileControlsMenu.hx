...
class MobileControlsMenu extends MusicBeatState
{
    ...
    override public function create():Void
    {
        ...
        leftArrow.cameras = [ui]; // UI üzerine yerleştirildi
        add(leftArrow);
        ...
        rightArrow.cameras = [ui]; // UI üzerine yerleştirildi
        add(rightArrow);
        ...
        upPozition.cameras = [ui]; // UI üzerine yerleştirildi
        add(upPozition);
        ...
        downPozition.cameras = [ui]; // UI üzerine yerleştirildi
        add(downPozition);
        ...
        leftPozition.cameras = [ui]; // UI üzerine yerleştirildi
        add(leftPozition);
        ...
        rightPozition.cameras = [ui]; // UI üzerine yerleştirildi
        add(rightPozition);
        ...
        spacePozition.cameras = [ui]; // UI üzerine yerleştirildi
        add(spacePozition);
        ...
        shiftPozition.cameras = [ui]; // UI üzerine yerleştirildi
        add(shiftPozition);
        ...
        tipText.cameras = [ui]; // UI üzerine yerleştirildi
        add(tipText);
        ...
        exit.cameras = [ui]; // UI üzerine yerleştirildi
        add(exit);
