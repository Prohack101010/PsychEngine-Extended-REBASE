...
function onCreate()
	...
	makeLuaAssetsSprite('abotEyeBack', 'empty', getProperty('gf.x') -80, getProperty('gf.y') +550);
	makeGraphic('abotEyeBack', 110, 70, 'FFFFFF');

	makeAnimatedLuaAssetsSprite('abotEyes', 'characters/abot/systemEyes', getProperty('gf.x') -76, getProperty('gf.y') +549)
	addAnimationByPrefix('abotEyes', 'l', 'Left', 24, false)
	addAnimationByPrefix('abotEyes', 'r', 'Right', 24, false)

	makeLuaAssetsSprite('abotBG', 'characters/abot/stereoBG', getProperty('gf.x') +18, getProperty('gf.y') +318);
	scaleObject('abotBG', 1.05, 1.05);

	makeAnimatedLuaAssetsSprite('abotViz1', 'aBotViz', getProperty('gf.x') +66, getProperty('gf.y') +390);
	...
	makeAnimatedLuaAssetsSprite('abotViz2', 'aBotViz', getProperty('gf.x') +128, getProperty('gf.y') +383);
	...
	makeAnimatedLuaAssetsSprite('abotViz3', 'aBotViz', getProperty('gf.x') +185, getProperty('gf.y') +380);
	...
	makeAnimatedLuaAssetsSprite('abotViz4', 'aBotViz', getProperty('gf.x') +251, getProperty('gf.y') +380);
	...
	makeAnimatedLuaAssetsSprite('abotViz5', 'aBotViz', getProperty('gf.x') +308, getProperty('gf.y') +380);
	...
	makeAnimatedLuaAssetsSprite('abotViz6', 'aBotViz', getProperty('gf.x') +364, getProperty('gf.y') +385);
	...
	makeAnimatedLuaAssetsSprite('abotViz7', 'aBotViz', getProperty('gf.x') +416, getProperty('gf.y') +393);
	...
	makeAnimatedLuaAssetsSprite('abot', 'characters/abot/abotSystem', getProperty('gf.x') -135, getProperty('gf.y') +310)
